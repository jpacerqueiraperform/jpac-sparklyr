...
conviva11_file <- read.csv("/home/analyticsdb/projects/r-studio/AVG_Bitrate/conviva11.csv")
conviva12_file <- read.csv("/home/analyticsdb/projects/r-studio/AVG_Bitrate/conviva12.csv")
conviva_file <- rbind(conviva11_file, conviva12_file)
head(conviva_file)

conviva11_csv_df <- spark_read_csv(sc,"conviva11","hdfs://bda-ns//user/analyticsdb/conviva11.csv")
conviva12_csv_df <- spark_read_csv(sc,"conviva12","hdfs://bda-ns//user/analyticsdb/conviva12.csv")
